    ...
    return (
        <main className="auth-layout">
            ...
            <section className="auth-right-section">
                <div className="z-10 relative lg_mt-4 lg:mb-16">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <cite className="auth-testemonial-author">- Ethan R.</cite>
                ...
                <div className="flex-1 relative">
                    <Image src="/public/assets/images/dashboard.png" alt="Dashboart Preview" height={1150} width={1440} className="/auth-dashboard-preview absolute top-0"/>
                </div>
            </section>
        </main>
    )
